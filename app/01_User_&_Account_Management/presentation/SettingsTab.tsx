...
const defaults: AccountSettings = { notificationsEnabled: true, language: "en", theme: "light", privacyLevel: "private" };

export default function SettingsTab({ initial, onSave }: { initial?: AccountSettings; onSave: (data: AccountSettings) => Promise<void> }) {
  const [settings, setSettings] = useState<AccountSettings>(initial ?? defaults);
