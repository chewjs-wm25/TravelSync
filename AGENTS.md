...
3. Your module is 02
4. To use the development environment, run devcontainer exec --workspace-folder . <command> in the project directory
5. Use npm run preview instead of npm run build|dev
6. Use sudo/root permissions with caution
